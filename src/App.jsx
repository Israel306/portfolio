  ...
  return (
    <>
      ...
      <div className="bg-slate-100 min-h-screen">
        <div className="px-5 md:px-0 container-w pt-10 md:pt-20 flex flex-col lg:flex-row justify-between items-center lg:items-start">
          {/* Left Section */}
          <div className="text-[#000033] max-w-3xl">
            ...
            <p className="pt-5 font-normal text-lg leading-loose text-justify">
              ...
              projects like my thesis on predicting student academic performance
              with machine learning. My goal is to leverage big data, AI, and
              advanced analytics to solve challenges in healthcare, education,
              and business.
            </p>
        ...
        <section className="px-5 md:px-0 container-w text-[#000033] pt-20">
          <div className="flex justify-center items-center text-center">
            <div className="flex flex-col">
              <p className="text-[#00d4ff] text-[18px]">SKILLS</p>
              <h1 className="mt-3 text-[25px]">
                {" "}
                Some of My <span className="text-[#00d4ff]"> Skills </span> And
                Technologies
              </h1>
            </div>
          </div>
        ...
        <section className="px-5 md:px-0 container-w text-[#000033] pt-20">
            ...
            <div className="bg-white border rounded-lg shadow-md p-5 mt-4">
              <ul className="list-disc list-inside">
                ...
                <li>
                  ...
                  candidates in the department, evaluated based on GPA, research
                  contributions, and leadership activities.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-10">
            ...
            <div className="bg-white border rounded-lg shadow-md p-5 mt-4">
              <ul className="list-disc list-inside">
                <li className="py-2">
                  <span className="font-bold">I.M. Ogundele,</span> O. Taiwo, A.
                  E. Babalola, and O. C. Ayeni, "Prediction of Student Academic
                  Performance Based on Machine Learning Model," 2024
                  International Conference on Science, Engineering and Business
                  for Driving Sustainable Development Goals (SEB4SDG), Omu-Aran,
                  Nigeria, 2024, pp. 1-11,
                  <a
                  ...
                  . Keywords: (Training; Accuracy; Machine learning algorithms;
                  Linear regression; Predictive models; Prediction algorithms).
                </li>
              </ul>
            </div>
          </div>
